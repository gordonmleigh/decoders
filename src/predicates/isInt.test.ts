...
describe('integer', () => {
  ...
  it('decodes the biggest possible integer', () => {
    const result = isInt.decode(Number.MAX_SAFE_INTEGER);
  ...
  it('decodes the smallest possible integer', () => {
    const result = isInt.decode(Number.MIN_SAFE_INTEGER);
  ...
  it('rejects a float', () => {
    const result = isInt.decode(3.14);
  ...
  it('rejects an unsafe integer', () => {
    const result = isInt.decode(Number.MAX_SAFE_INTEGER + 1);
  ...
  it('rejects an unsafe negative integer', () => {
    const result = isInt.decode(Number.MIN_SAFE_INTEGER - 1);
